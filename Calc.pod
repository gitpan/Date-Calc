...
day in a year (from 1 to 365 or 366) is frequently called the "Julian date".

In fact the calendar that was used B<BEFORE> the Gregorian calendar
...
This man page documents "Date::Calc" version 5.2.
