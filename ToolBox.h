...
// Thus here you will get an "Type already defined" error when compiling Calc.c,
// but not for DateCalc.c, because it doesn't include MacTypes.h. I've declared
// a define switch MPW_HAS_BOOL, which must be set to 1 while compiling Calc.c, i.e.
// while building the shared lib for Perl
