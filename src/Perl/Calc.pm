...
sub DATECALC_USAGE
{
    croak('Usage: Date::Calc::' . $_[0]);
}
sub DATECALC_ERROR
{
    croak("Date::Calc::$_[0](): $_[1]");
}
sub DATECALC_DATE_ERROR
{
    croak("Date::Calc::$_[0](): not a valid date");
}
sub DATECALC_TIME_ERROR
{
    croak("Date::Calc::$_[0](): not a valid time");
}
sub DATECALC_YEAR_ERROR
{
    croak("Date::Calc::$_[0](): year out of range");
}
sub DATECALC_MONTH_ERROR
{
    croak("Date::Calc::$_[0](): month out of range");
}
sub DATECALC_WEEK_ERROR
{
    croak("Date::Calc::$_[0](): week out of range");
}
sub DATECALC_DAYOFWEEK_ERROR
{
    croak("Date::Calc::$_[0](): day of week out of range");
}
sub DATECALC_DATE_RANGE_ERROR
{
    croak("Date::Calc::$_[0](): date out of range");
}
sub DATECALC_TIME_RANGE_ERROR
{
    croak("Date::Calc::$_[0](): time out of range");
}
sub DATECALC_FACTOR_ERROR
{
    croak("Date::Calc::$_[0](): factor out of range");
}
sub DATECALC_LANGUAGE_ERROR
{
    croak("Date::Calc::$_[0](): language not available");
}
sub DATECALC_SYSTEM_ERROR
{
    croak("Date::Calc::$_[0](): not available on this system");
}
sub DATECALC_MEMORY_ERROR
{
    croak("Date::Calc::$_[0](): unable to allocate memory");
}
sub DATECALC_STRING_ERROR
{
    croak("Date::Calc::$_[0](): argument is not a string");
}
sub DATECALC_SCALAR_ERROR
{
    croak("Date::Calc::$_[0](): argument is not a scalar");
}
