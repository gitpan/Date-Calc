...
if ($Date::Calc::Object::VERSION eq '5.5')
{print "ok $n\n";} else {print "not ok $n\n";}
$n++;
...
if ($Date::Calendar::Profiles::VERSION eq '5.5')
{print "ok $n\n";} else {print "not ok $n\n";}
$n++;
...
if ($Date::Calendar::Year::VERSION eq '5.5')
{print "ok $n\n";} else {print "not ok $n\n";}
$n++;
...
if ($Date::Calendar::VERSION eq '5.5')
{print "ok $n\n";} else {print "not ok $n\n";}
$n++;
